...
define('pilots/components/pilot-profile', ['exports', 'ember', 'pilots/config/environment'], function (exports, _ember, _pilotsConfigEnvironment) {
  ...
  PilotProfileComponent = _ember['default'].Component.extend({
    ...
    onInit: _ember['default'].on('init', function () {
      if (this.get('model.pilotLicenses.length') === 0 || this.get('model.pilotDrones.length') === 0 || !this.get('model.pilot').get('travel_distance') || this.get('model.pilotDevices.length') === 0) {
    ...
    missingInfoCount: _ember['default'].computed('model', 'model.pilot', 'model.pilotLicenses.[]', 'model.pilotDrones.[]', 'model.pilot.travel_distance', function () {
      var count, pilot;
      pilot = this.get('model.pilot');
      count = 0;
      if (this.get('model.pilotLicenses.length') === 0) {
    ...
    actions: {
      ...
      step1: function step1() {
        ...
        } else if (!this.get('model.pilot').get('travel_distance')) {
      ...
      step5: function step5() {
        this.get('hideToolTipsAndUnfocus')();
        if (!this.get('model.pilot').get('travel_distance')) {
          return this.get('goToAvailability')();
        } else {
          return this.get('finishToolTips')();
        }
...
define("pilots/components/test", ["exports"], function (exports) {});
/*
 ---
 name: Test
 category: Components
...
define("pilots/data/travel_distance", ["exports"], function (exports) {
...
define('pilots/routes/pilot/edit', ['exports', 'ember', 'pilots/data/iso_country', 'pilots/data/travel_distance', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _pilotsDataIso_country, _pilotsDataTravel_distance, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
  var PilotsEditRoute;
  ...
  PilotsEditRoute = _ember['default'].Route.extend(_emberSimpleAuthMixinsAuthenticatedRouteMixin['default'], {
    model: function model(params) {
      return _ember['default'].RSVP.hash({
        pilot: this.store.findRecord('pilot', 'stubId'),
        travelDistance: _pilotsDataTravel_distance['default'],
...
define('pilots/routes/pilot/new', ['exports', 'ember', 'ember-simple-auth/mixins/unauthenticated-route-mixin', 'pilots/data/iso_country', 'pilots/data/travel_distance'], function (exports, _ember, _emberSimpleAuthMixinsUnauthenticatedRouteMixin, _pilotsDataIso_country, _pilotsDataTravel_distance) {
  var PilotRoute;
...
define('pilots/routes/pilotaccount', ['exports', 'ember', 'pilots/data/iso_country', 'pilots/data/travel_distance', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _pilotsDataIso_country, _pilotsDataTravel_distance, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
...
define('pilots/routes/profile', ['exports', 'ember', 'pilots/data/iso_country', 'pilots/data/travel_distance', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _pilotsDataIso_country, _pilotsDataTravel_distance, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
  var ProfileRoute;
