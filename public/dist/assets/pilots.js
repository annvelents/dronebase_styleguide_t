...
define('pilots/components/asset-uploader', ['exports', 'ember', 'pilots/utils/w', 'pilots/config/environment'], function (exports, _ember, _pilotsUtilsW, _pilotsConfigEnvironment) {
  ...
  AssetUploaderComponent = _ember['default'].Component.extend({
    ...
    uploadsComplete: function uploadsComplete() {
      var confirm;
      confirm = window.confirm('Have you uploaded all public/assets for this mission?');
      if (!confirm) {
        return;
      }
      return this.updateStatus('public/assets_uploaded');
    },
    ...
    inProgress: _ember['default'].observer('queue.progress', function () {
      ...
      if (progress >= 100) {
        ...
        if (this.get('autoSubmitMission') && uploader.total.queued === 0) {
          ...
          if (this.get('mission.status') === 'public/assets_uploaded') {
            this.updateStatusAndReload('public/assets_classified').then((function (_this) {
              return function () {
                return _this.sendAction('toggleBulkUploaderModalAction');
              };
            })(this));
          } else if (this.get('mission.status') === 'flight_complete') {
            this.updateStatusAndReload('public/assets_uploaded').then((function (_this) {
              return function () {
                return _this.updateStatusAndReload('public/assets_classified').then(function () {
                  return _this.sendAction('toggleBulkUploaderModalAction');
                });
              };
            })(this));
            ...
            this.updateStatusAndReload('flight_complete').then((function (_this) {
              return function () {
                return _this.updateStatusAndReload('public/assets_uploaded').then(function () {
                  return _this.updateStatusAndReload('public/assets_classified').then(function () {
                    return _this.sendAction('toggleBulkUploaderModalAction');
                  });
                });
...
define('pilots/components/client-mission-uploader', ['exports', 'ember', 'pilots/config/environment', 'pilots/components/asset-uploader'], function (exports, _ember, _pilotsConfigEnvironment, _pilotsComponentsAssetUploader) {
  ...
  ClientMissionUploader = _pilotsComponentsAssetUploader['default'].extend({
    ...
    currentImages: _ember['default'].computed('currentShot', 'mission.unassignedImages.[]', function () {
      if (this.get('currentShot') === 'allpublic/assets') {
        return this.get('mission.images').sortBy('uploadNumber');
      }
      if (this.get('currentShot') === 'unassignedpublic/assets') {
    ...
    currentpublic/assets: _ember['default'].computed.union('currentImages', 'currentVideos'),
    showInstructions: _ember['default'].computed('currentpublic/assets.length', function () {
      return this.get('currentpublic/assets.length') === 0;
    }),
    readyToSubmit: _ember['default'].computed('mission.pilotShots.@each.readyToSubmit', 'mission.unassignedpublic/assetsCount', function () {
      var ready;
      ready = true;
      this.get('mission.pilotShots').forEach(function (shot) {
        return ready = ready && shot.get('readyToSubmit');
      });
      return ready && this.get('mission.unassignedpublic/assetsCount') === 0;
    }),
    didInsertElement: function didInsertElement() {
      this._super();
    ...
    initShotListScroll: function initShotListScroll() {
      var public/assets, shotList, win;
      win = $(window);
      shotList = $('.shot-list');
      public/assets = $('.public/assets');
      return win.scroll((function (_this) {
        return function () {
          if (win.scrollTop() > public/assets.offset().top - 20) {
            if (_this.get('lastShotListWidth') === 0) {
              _this.set('lastShotListWidth', shotList.width());
              _this.set('lastAssetLeft', public/assets.offset().left);
            }
            shotList.css({
              position: 'fixed',
              top: '20px',
    ...
    selectedpublic/assets: function selectedpublic/assets() {
      var asset, i, len, ref, selected;
      selected = [];
      ref = this.get('currentpublic/assets');
      for (i = 0, len = ref.length; i < len; i++) {
        asset = ref[i];
    ...
    mouseDown: function mouseDown(e) {
      ...
      asset = this.get('mission.allpublic/assets').filterBy('id', assetId);
    ...
    toggleRange: function toggleRange(assetId1, assetId2) {
      ...
      return this.selectedpublic/assets();
    },
    ...
    deselectAll: function deselectAll() {
      var asset, i, len, ref;
      ref = this.get('mission.allpublic/assets');
      for (i = 0, len = ref.length; i < len; i++) {
        asset = ref[i];
        asset.set('isSelected', false);
      }
    ...
    addAsset: function addAsset(file) {
      ...
      if (this.get('mission.status') !== 'public/assets_uploaded') {
        this.updateStatus('public/assets_uploaded');
      }
    ...
    init: function init() {
      this._super();
      this.set('currentShot', 'unassignedpublic/assets');
      this.set('unassignedpublic/assets', true);
      this.set('commentButtonName', 'SAVE COMMENT');
      if (this.get('currentpublic/assets').length > 100) {
    ...
    actions: {
      ...
      assignAsset: function assignAsset(_asset, options) {
        var asset, public/assets, i, len, shot;
        public/assets = this.selectedpublic/assets();
        shot = options.target.shot;
        if (!public/assets.contains(_asset)) {
          public/assets.push(_asset);
        }
        for (i = 0, len = public/assets.length; i < len; i++) {
          asset = public/assets[i];
          asset.set('shot', shot);
          if (asset.get('isNew')) {
      ...
      clickShot: function clickShot(shot, options) {
        ...
        if (shot === 'unassignedpublic/assets') {
          this.set('unassignedpublic/assets', true);
        } else {
          this.set('unassignedpublic/assets', false);
        }
      ...
      deleteShot: function deleteShot(shot) {
        if (shot.get('images.length') || shot.get('videos.length')) {
          alert('Please remove public/assets from shot first.');
          return;
        }
        ...
        return shot.destroyRecord().then((function (_this) {
          return function () {
            _this.set('currentShot', 'unassignedpublic/assets');
            return _this.set('unassignedpublic/assets', true);
          };
        })(this));
      },
      ...
      deletepublic/assets: function deletepublic/assets() {
        var targets;
        if (!confirm('Do you want to delete the selected public/assets?')) {
          return;
        }
        targets = [];
        this.selectedpublic/assets().forEach(function (asset) {
          var item, type;
        ...
        return _ember['default'].$.ajax({
          url: _pilotsConfigEnvironment['default'].api.host + "/v1/pilots/missions/" + this.get('mission.id') + "/public/assets/delete_all",
          type: 'POST',
          dataType: 'json',
          headers: this.get('sessionAccount.headers'),
          data: {
          ...
          return alert('Sorry, there was an error while deleting these public/assets.');
        });
      },
...
define('pilots/components/client-mission', ['exports', 'ember', 'pilots/config/environment', 'pilots/utils/feature-manager'], function (exports, _ember, _pilotsConfigEnvironment, _pilotsUtilsFeatureManager) {
  ...
  ClientMissionComponent = _ember['default'].Component.extend({
    ...
    readyToSubmit: _ember['default'].computed('model.mission.status', 'public/assetsClassified', function () {
      return this.get('model.mission.status') === 'public/assets_uploaded' && this.get('public/assetsClassified');
    }),
    ...
    actions: {
      ...
      doneClassifying: function doneClassifying() {
        return this.set('public/assetsClassified', true);
      },
      back: function back() {
        return this.set('public/assetsClassified', false);
      },
      ...
      submitMission: function submitMission() {
        return this.updateStatus('public/assets_classified');
      },
...
define('pilots/components/dashboard-map', ['exports', 'ember', 'pilots/config/environment', 'pilots/data/mission_type', 'pilots/data/map_style'], function (exports, _ember, _pilotsConfigEnvironment, _pilotsDataMission_type, _pilotsDataMap_style) {
  ...
  DashboardMapComponent = _ember['default'].Component.extend({
    ...
    public/assetsDir: 'public/assets/images/v2/',
    actions: {
    ...
    setupFilters: function setupFilters() {
      ...
      return this.missionTypeData.forEach((function (_this) {
        return function (mission_type) {
          ...
          missionType.selected_png = _this.get('assetMap').resolve(_this.public/assetsDir + icon_png);
          missionType.png = _this.get('assetMap').resolve(_this.public/assetsDir + missionType.png);
  ...
  GettyMissionComponent = _pilotsComponentsAssetUploader['default'].extend(_pilotsValidationsGetty['default'], {
    ...
    progressObserver: (function () {
      ...
      if (this.get('uploadProgress') >= 100 && !this.get('uploadComplete')) {
        ...
        return this.updateStatus('public/assets_classified', callback);
      }
    ...
    initGettyImages: function initGettyImages() {
      $(".overlay1").hover(function () {
        return $(this).find('img').attr('src', "/public/assets/images/getty/Getty-infographic_Skyline.gif");
      }, function () {
        return $(this).find('img').attr('src', "/public/assets/images/getty/Getty-infographic_Skyline.png");
      });
      $(".overlay2").hover(function () {
        return $(this).find('img').attr('src', "/public/assets/images/getty/Getty-infographic_Upload.gif");
      }, function () {
        return $(this).find('img').attr('src', "/public/assets/images/getty/Getty-infographic_Upload.png");
      });
      return $(".overlay3").hover(function () {
        return $(this).find('img').attr('src', "/public/assets/images/getty/Getty-infographic_Upload-Money.gif");
      }, function () {
        return $(this).find('img').attr('src', "/public/assets/images/getty/Getty-infographic_Upload-Money.png");
      });
    },
  ...
  MissionMapComponent = _ember['default'].Component.extend(_emberCliFileSaverMixinsFileSaver['default'], {
    featureOptions: {
      ...
      POINTOFINTEREST: {
        ...
        defaultOptions: {
          paths: null,
          draggable: false,
          icon: '/public/assets/images/blank.png',
          zIndex: 3
        }
      }
    },
    ...
    addMarker: function addMarker(position, draggable) {
      ...
      marker = new google.maps.Marker({
        ...
        animation: animation,
        icon: {
          url: '/public/assets/images/v2/client_mission_assigned.png'
        }
      });
      _this = this;
...
define('pilots/components/notification-dropdown', ['exports', 'ember'], function (exports, _ember) {
  ...
  NotificationComponent = _ember['default'].Component.extend({
    ...
    public/assetsDir: 'public/assets/images/notifications/',
    assetMap: _ember['default'].inject.service(),
    ...
    icon: _ember['default'].computed('model.fontIcon', function () {
      ...
      if (!this.get('read')) {
        return this.get('assetMap').resolve(this.public/assetsDir + this.get('model.fontIcon'));
      }
      iconArray = this.get('model.fontIcon').split('.');
      iconArray[0] = iconArray[0] + '_read';
      newAssetUrl = iconArray.join('.');
      return this.get('assetMap').resolve(this.public/assetsDir + newAssetUrl);
    }),
    router: _ember['default'].computed(function () {
      return _ember['default'].getOwner(this).lookup('router:main');
    }).readOnly(),
...
define('pilots/components/pano-mission-uploader', ['exports', 'ember', 'pilots/utils/w', 'pilots/config/environment', 'pilots/components/asset-uploader'], function (exports, _ember, _pilotsUtilsW, _pilotsConfigEnvironment, _pilotsComponentsAssetUploader) {
  ...
  PanoMissionUploaderComponent = _pilotsComponentsAssetUploader['default'].extend({
    ...
    actions: {
      deleteAllpublic/assets: function deleteAllpublic/assets() {
        var targets;
        if (!confirm("Do you want to delete all " + this.get('mission.public/assetsCount') + " public/assets for this shot?")) {
          return;
        }
        targets = [];
...
define('pilots/components/pano-mission', ['exports', 'ember', 'pilots/config/environment', 'pilots/utils/init-qtip'], function (exports, _ember, _pilotsConfigEnvironment, _pilotsUtilsInitQtip) {
  ...
  PanoMissionComponent = _ember['default'].Component.extend({
    ...
    missionComplete: _ember['default'].computed('model.mission.status', function () {
      return this.get('model.mission.status') === 'public/assets_classified';
    }),
    ...
    actions: {
      ...
      submitMission: function submitMission() {
        ...
        headers = this.get('sessionAccount.headers');
        return _ember['default'].$.ajax({
          url: _pilotsConfigEnvironment['default'].api.host + "/v1/pilots/missions/" + _mission.id + "/status/public/assets_classified",
          type: 'PATCH',
          dataType: 'json',
          headers: headers
        }).then(function (response) {
...
define('pilots/components/pilot-mission-list', ['exports', 'ember', 'pilots/config/environment'], function (exports, _ember, _pilotsConfigEnvironment) {
  ...
  PilotMissionListComponent = _ember['default'].Component.extend({
    ...
    sortMissions: function sortMissions(a, b) {
      var missionOrder;
      missionOrder = ['pilots_notified', 'pilot_accepted', 'flight_complete', 'public/assets_uploaded'];
...
define('pilots/components/pilot-profile', ['exports', 'ember', 'pilots/config/environment'], function (exports, _ember, _pilotsConfigEnvironment) {
  ...
  PilotProfileComponent = _ember['default'].Component.extend({
    ...
    onInit: _ember['default'].on('init', function () {
      if (this.get('model.pilotLicenses.length') === 0 || this.get('model.pilotDrones.length') === 0 || !this.get('model.pilot').get('travel_public/distance') || this.get('model.pilotDevices.length') === 0) {
    ...
    missingInfoCount: _ember['default'].computed('model', 'model.pilot', 'model.pilotLicenses.[]', 'model.pilotDrones.[]', 'model.pilot.travel_public/distance', function () {
      var count, pilot;
      pilot = this.get('model.pilot');
      count = 0;
      if (this.get('model.pilotLicenses.length') === 0) {
      ...
      if (!pilot.get('travel_public/distance')) {
        count += 1;
      }
      if (this.get('model.pilotDevices.length') === 0) {
        count += 1;
    ...
    actions: {
      ...
      step1: function step1() {
        ...
        } else if (!this.get('model.pilot').get('travel_public/distance')) {
      ...
      step5: function step5() {
        this.get('hideToolTipsAndUnfocus')();
        if (!this.get('model.pilot').get('travel_public/distance')) {
          return this.get('goToAvailability')();
        } else {
          return this.get('finishToolTips')();
        }
...
define('pilots/components/upload-public/assets-other-app', ['exports', 'ember', 'pilots/config/environment', 'ember-cli-file-saver/mixins/file-saver'], function (exports, _ember, _pilotsConfigEnvironment, _emberCliFileSaverMixinsFileSaver) {
  var Uploadpublic/assetsOtherAppComponent;

  Uploadpublic/assetsOtherAppComponent = _ember['default'].Component.extend(_emberCliFileSaverMixinsFileSaver['default'], {
    classNames: ['upload-public/assets-with-other-app'],
    sessionAccount: _ember['default'].inject.service(),
  ...
  exports['default'] = Uploadpublic/assetsOtherAppComponent;
});
  ...
  ValidatedCheckboxImageAutoSaveComponent = _ember['default'].Component.extend({
    ...
    setImage: function setImage() {
      if (this.get('changeset').get(this.get('propertyName'))) {
        return this.$('img').attr('src', '/public/assets/images/checkmark_selected.svg');
      } else {
        return this.$('img').attr('src', '/public/assets/images/checkmark_unselected.svg');
      }
    },
    didInsertElement: function didInsertElement() {
...
define("pilots/data/travel_public/distance", ["exports"], function (exports) {
  ...
  Mission = _emberData['default'].Model.extend({
    ...
    pilotShots: Ember.computed('shots.[]', function () {
      ...
      this.get('shots').forEach(function (shot) {
        if (shot.get('shot_type.name') !== 'Final public/assets') {
    ...
    allpublic/assets: Ember.computed.union('images', 'videos'),
    ...
    showOnHold: Ember.computed('is_on_hold', function () {
      ...
      return this.get('is_on_hold') && (status === 'pilots_notified' || status === 'pilot_accepted' || status === 'public/assets_uploaded' || status === 'public/assets_classified');
    }),
    ...
    unassignedpublic/assetsCount: Ember.computed('unassignedVideos.[]', 'unassignedImages.[]', function () {
    ...
    public/assetsCount: Ember.computed('allpublic/assets.[]', function () {
      return this.get('allpublic/assets.length');
    }),
    ...
    missionComplete: Ember.computed('status', 'flight_app', function () {
      ...
      return status !== 'pilot_assigned' && status !== 'flight_complete' && status !== 'public/assets_uploaded' && status !== 'pilot_accepted';
    }),
    haspublic/assets: Ember.computed('images', 'videos', function () {
    ...
    uploadedDate: Ember.computed('status_timestamps', function () {
      var date;
      date = this.get('status_timestamps.public/assets_uploaded');
      if (!date) {
        return date = this.get('status_timestamps.public/assets_classified');
      }
    }),
...
define('pilots/models/pilot', ['exports', 'ember-data', 'pilots/models/rescheduler'], function (exports, _emberData, _pilotsModelsRescheduler) {
  ...
  Pilot = _pilotsModelsRescheduler['default'].extend({
    ...
    longitude: _emberData['default'].attr('string'),
    latitude: _emberData['default'].attr('string'),
    travel_public/distance: _emberData['default'].attr('number'),
...
define('pilots/models/shot', ['exports', 'ember-data'], function (exports, _emberData) {
  ...
  Shot = _emberData['default'].Model.extend({
    ...
    public/assetsCount: Ember.computed('images.[]', 'videos.[]', function () {
      return this.get('images.length') + this.get('videos.length');
    }),
    readyToSubmit: Ember.computed('public/assetsCount', 'pilot_comment', function () {
      return !!this.get('public/assetsCount') || !!this.get('pilot_comment');
    }),
    isDeletable: false,
    ...
    model: function model(params) {
      ...
      return _ember['default'].RSVP.hash({
        ...
        missions: this.store.query('mission', {
          status: 'available,pilot_accepted,flight_complete,public/assets_uploaded',
          per_page: 50,
...
define('pilots/routes/pilot/edit', ['exports', 'ember', 'pilots/data/iso_country', 'pilots/data/travel_public/distance', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _pilotsDataIso_country, _pilotsDataTravel_public/distance, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
  var PilotsEditRoute;
  ...
  PilotsEditRoute = _ember['default'].Route.extend(_emberSimpleAuthMixinsAuthenticatedRouteMixin['default'], {
    model: function model(params) {
      return _ember['default'].RSVP.hash({
        pilot: this.store.findRecord('pilot', 'stubId'),
        travelpublic/distance: _pilotsDataTravel_public/distance['default'],
...
define('pilots/routes/pilot/new', ['exports', 'ember', 'ember-simple-auth/mixins/unauthenticated-route-mixin', 'pilots/data/iso_country', 'pilots/data/travel_public/distance'], function (exports, _ember, _emberSimpleAuthMixinsUnauthenticatedRouteMixin, _pilotsDataIso_country, _pilotsDataTravel_public/distance) {
  var PilotRoute;
...
define('pilots/routes/pilotaccount', ['exports', 'ember', 'pilots/data/iso_country', 'pilots/data/travel_public/distance', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _pilotsDataIso_country, _pilotsDataTravel_public/distance, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
    ...
    model: function model(params) {
      return _ember['default'].RSVP.hash({
        ...
        missions: this.findPaged('mission', {
          status: 'public/assets_classified,in_production,awaiting_payment,invoice_needed,invoiced,complete,rejected',
          per_page: 20
        })
      });
    },
...
define('pilots/routes/profile', ['exports', 'ember', 'pilots/data/iso_country', 'pilots/data/travel_public/distance', 'ember-simple-auth/mixins/authenticated-route-mixin'], function (exports, _ember, _pilotsDataIso_country, _pilotsDataTravel_public/distance, _emberSimpleAuthMixinsAuthenticatedRouteMixin) {
  var ProfileRoute;
...
define("pilots/templates/components/validated-checkbox-image-auto-save", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "Ocl1xuBY", "block": "{\"statements\":[[11,\"img\",[]],[15,\"src\",\"/public/assets/images/checkmark_selected.svg\"],[5,[\"action\"],[[28,[null]],\"validateProperty\",[28,[\"changeset\"]],[28,[\"propertyName\"]]]],[13],[14],[0,\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}", "meta": { "moduleName": "pilots/templates/components/validated-checkbox-image-auto-save.hbs" } });
});
